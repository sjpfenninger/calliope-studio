...
Calligraph reads a model definition two ways, and the distinction is the whole
...
that, and until this module existed calligraph answered it with a second
...
from calligraph.modeldef import snapshot
from calligraph.modeldef.imports import find_model_yaml
from calligraph.results import store as results_store
