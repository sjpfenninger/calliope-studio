...
HTTP. It is a thin adapter over `calliope_studio.modeldef`, `calliope_studio.runs` and
`calliope_studio.results` — route handlers should contain routing, validation and
